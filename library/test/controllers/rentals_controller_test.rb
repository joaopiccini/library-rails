...
class RentalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post rentals_url, params: { rental: { book_id: @rental.book_id, rental: @rental.rental, user_id: @rental.user_id } }
    end
  ...
  test "should update rental" do
    patch rental_url(@rental), params: { rental: { book_id: @rental.book_id, rental: @rental.rental, user_id: @rental.user_id } }
